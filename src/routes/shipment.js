...
router.get('/update/:id', requireAuth, getUpdateShipment);
router.post('/update/:id', requireAuth, validateUpdateShipment, handleUpdateValidationErrors, updateShipment);
